...
export default {
    data() {
        return {
            ...
            urls: [],
            page: 1,
            url: "https://wall.alphacoders.com/api2.0/get.php?auth=1a1e07617b922b49f1f1efb53cf1326f&method=search&&width=1920&height=1080",
        };
    },
    created() {
        this.getNewImage();
    ...
    methods: {
        ...
        getNewImage() {
            let url = `https://wall.alphacoders.com/api2.0/get.php?auth=1a1e07617b922b49f1f1efb53cf1326f&method=random&page=10&info_level=2&page=${this.page}`;
            this.axios
                .get(url, {
                    headers: {
                        "Content-Type": "application/json",
